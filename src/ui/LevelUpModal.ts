    ...
    const pick = new Promise<PowerupChoice>((resolve) => {
      for (const option of choices) {
        ...
        switch(option.family) {
          ...
          case 'Wings': iconSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m2 22 1-6c.55-3.31 2.5-6.19 5.36-7.8L12 6c3.64-2.18 8-2.6 10-2-2 2-2.42 6.36-2 10l-2.2 3.64C16.19 20.5 13.31 22.45 10 23l-6 1a1.5 1.5 0 0 1-1.73-1.73l1-6Z"></path><path d="m9 15 3.5-3.5"></path><path d="m11 18 3.5-3.5"></path></svg>'; break;
